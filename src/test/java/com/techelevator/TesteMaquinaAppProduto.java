...
public class TesteMaquinaAppProduto {
    ...
    /* Chama a hierarquia do add_produto */
    VendingMachineAddProdutoImplementacao add_produto = new VendingMachineAddProdutoImplementacao();

    @Test
    public void Teste1() {
        menu_principal.menu_principal();
        menu_principal.e_escolhe_opcao5();
        menu_principal.add_produto();
        add_produto.add_produto();
        add_produto.e_escolhe_opcao1();
        add_produto.add_espera_produto();
        add_produto.e_insere_codigo_incorreto();
        add_produto.add_espera_produto();
        add_produto.e_insere_codigo();
        add_produto.espera_quantidade();
        add_produto.e_qtd_incorreta();
        add_produto.espera_quantidade();
        add_produto.e_qtd_correta();
        add_produto.atualiza_quantidade();
        add_produto.e_atualiza_qnt();
        add_produto.add_produto();
        add_produto.e_escolhe_opcao2();
        add_produto.add_finaliza_acao();
        add_produto.e_entra_menuPrincipal();
        add_produto.menu_principal();
        menu_principal.menu_principal();
        add_produto.menu_principal();
        menu_principal.menu_principal();
        add_produto.menu_principal();
